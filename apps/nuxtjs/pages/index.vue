<template>
  <NuxtLayout name="custom">
    <template #header>
      <HeaderComponent :isHeroImage=true />
    </template>
        ...
        <li class="feature__item feature__item--no-overlap-img">
          <article class="feature__item-container">
            ...
            <div class="feature__content">
              ...
              <p class="feature__body">Upgrade to premium speakers that are phenomenally built to deliver truly remarkable sound.</p>
    ...
    <section class="overview">
      <picture class="overview__picture">
        <source
          srcset="~/assets/images/desktop/image-best-gear.jpg"
          media="(min-width: 1440px)"
        >
        <source
          srcset="~/assets/images/tablet/image-best-gear.jpg"
          media="(min-width: 768px)"
        >
        <img
      ...
      <h2 class="overview__title">
        Bringing you the <span class="overview__title--emphasis">best</span> audio gear
      </h2>
